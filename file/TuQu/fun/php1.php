	  				...
	  				$_SESSION['time_2']=date('h:i:s');
								...
								$ch_q=("select * from time where phno='$phno';");
												...
												if($value['t3']=='null')
												{
													...
													$timeq=("update time set t3='$time' where time.phno='$phno';");
							...
							if($exe_array1['point']==20)
							{
								$timeq1=("update student set point='30' where student.phno='$ph';");
